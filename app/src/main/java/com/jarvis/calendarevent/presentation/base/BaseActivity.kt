...
import com.jarvis.calendarevent.presentation.common.enum.ThemeMode
import com.jarvis.calendarevent.presentation.common.helper.ThemeHelper
import com.jarvis.design_system.toolbar.JxToolbar
import com.jarvis.calendarevent.presentation.common.pref.AppPreference
...
abstract class BaseActivity<B : ViewBinding, T : ViewModel>(val bindingFactory: (LayoutInflater) -> B) :
    ...
    open fun initDarkMode() {
        setTheme(R.style.Theme_CalendarI)
